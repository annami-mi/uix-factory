...
- **Лейбл — `type/label/m` 16/20 Medium** (решение 2026-09-24; до переименований шкалы 2026-09-25 — `label/lg`, затем `label/md`), в макете Figma `label/md` 14/16. Соответствие имён — `docs/figma-todo.md`.
