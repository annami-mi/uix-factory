...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: [
          "Таблица данных SaaS. **Mobile-first:** в узком контейнере строки — карточки, шапка — чипы сортировки; с ширины контейнера size/container/s (640px) — таблица с липкой шапкой.",
          "",
